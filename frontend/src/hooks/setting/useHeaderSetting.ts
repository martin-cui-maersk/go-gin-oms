...
export function useHeaderSetting() {
  ...
  const getShowMyAccount = computed(() => appStore.getHeaderSetting.showMyAccount);

  const getShowSelectMerchant = computed(() => appStore.getHeaderSetting.showSelectMerchant);
